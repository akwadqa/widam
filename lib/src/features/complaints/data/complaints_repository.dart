...
class ComplaintsRepository {
  ...
  Future<Complaint> sendComplaint({required String complaintType, required String description, required String subject}) async {
    ...
    Complaint complaint = Complaint.fromJson(response.data);
    return complaint;
  }
}